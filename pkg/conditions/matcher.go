...
// MatchConditions returns a custom matcher to check equality of crhelpertypes.Conditions.
func MatchConditions(expected crhelpertypes.Conditions) types.GomegaMatcher {
...
type matchConditions struct {
	expected crhelpertypes.Conditions
}
...
// MatchCondition returns a custom matcher to check equality of crhelpertypes.Condition.
func MatchCondition(expected crhelpertypes.Condition) types.GomegaMatcher {
...
type matchCondition struct {
	expected crhelpertypes.Condition
}

func (m matchCondition) Match(actual interface{}) (success bool, err error) {
	actualCondition, ok := actual.(crhelpertypes.Condition)
	if !ok {
