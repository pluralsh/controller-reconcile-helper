...
type mergeOptions struct {
	conditionTypes                     []crhelpertypes.ConditionType
	addSourceRef                       bool
	addStepCounter                     bool
	addStepCounterIfOnlyConditionTypes []crhelpertypes.ConditionType
	stepCounter                        int
}
...
func WithConditions(t ...crhelpertypes.ConditionType) MergeOption {
...
// IMPORTANT: This options works only while generating the Summary condition.
func WithStepCounterIfOnly(t ...crhelpertypes.ConditionType) MergeOption {
	return func(c *mergeOptions) {
...
func getFirstReason(g conditionGroups, order []crhelpertypes.ConditionType, addSourceRef bool) string {
...
func getFirstMessage(groups conditionGroups, order []crhelpertypes.ConditionType) string {
...
func getFirstCondition(g conditionGroups, priority []crhelpertypes.ConditionType) *localizedCondition {
	topGroup := g.TopGroup()
	if topGroup == nil {
		return nil
	}
