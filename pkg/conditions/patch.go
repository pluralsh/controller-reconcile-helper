...
type PatchOperation struct {
	Before *crhelpertypes.Condition
	After  *crhelpertypes.Condition
...
type applyOptions struct {
	ownedConditions []crhelpertypes.ConditionType
	forceOverwrite  bool
}

func (o *applyOptions) isOwnedCondition(t crhelpertypes.ConditionType) bool {
...
func WithOwnedConditions(t ...crhelpertypes.ConditionType) ApplyOption {
