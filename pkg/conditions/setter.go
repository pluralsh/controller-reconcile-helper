...
type Setter interface {
	Getter
	SetConditions(crhelpertypes.Conditions)
}
...
func Set(to Setter, condition *crhelpertypes.Condition) {
...
func TrueCondition(t crhelpertypes.ConditionType) *crhelpertypes.Condition {
	return &crhelpertypes.Condition{
		Type:   t,
...
func FalseCondition(t crhelpertypes.ConditionType, reason string, severity crhelpertypes.ConditionSeverity, messageFormat string, messageArgs ...interface{}) *crhelpertypes.Condition {
	return &crhelpertypes.Condition{
		Type:     t,
...
func UnknownCondition(t crhelpertypes.ConditionType, reason string, messageFormat string, messageArgs ...interface{}) *crhelpertypes.Condition {
	return &crhelpertypes.Condition{
		Type:    t,
...
func MarkTrue(to Setter, t crhelpertypes.ConditionType) {
	Set(to, TrueCondition(t))
}

// MarkUnknown sets Status=Unknown for the condition with the given type.
func MarkUnknown(to Setter, t crhelpertypes.ConditionType, reason, messageFormat string, messageArgs ...interface{}) {
...
func MarkFalse(to Setter, t crhelpertypes.ConditionType, reason string, severity crhelpertypes.ConditionSeverity, messageFormat string, messageArgs ...interface{}) {
...
func SetMirror(to Setter, targetCondition crhelpertypes.ConditionType, from Getter, options ...MirrorOptions) {
...
func SetAggregate(to Setter, targetCondition crhelpertypes.ConditionType, from []Getter, options ...MergeOption) {
	Set(to, aggregate(from, targetCondition, options...))
}

// Delete deletes the condition with the given type.
func Delete(to Setter, t crhelpertypes.ConditionType) {
	if to == nil {
		return
	}

	conditions := to.GetConditions()
	newConditions := make(crhelpertypes.Conditions, 0, len(conditions))
...
func lexicographicLess(i, j *crhelpertypes.Condition) bool {
	return (i.Type == crhelpertypes.ReadyCondition || i.Type < j.Type) && j.Type != crhelpertypes.ReadyCondition
}
...
func hasSameState(i, j *crhelpertypes.Condition) bool {
